...
// scope. Four of them declared `const { CVS_Animator }` at top level; the second
// onwards threw "Identifier 'CVS_Animator' has already been declared" and stopped
...
class CardVisualRenderer {
  constructor(options = {}) {
    ...
    this.animator = new CVS_Animator();
